          ...
          >
            ...
            <div className="flex items-center gap-6">
              <Button
                ...
                text={<span className="px-6 py-2 text-base font-medium">Learn More</span>}
                className="rounded-full bg-gradient-to-r from-purple-600 to-blue-500 dark:from-purple-400 dark:to-blue-300 text-white font-semibold shadow-lg hover:brightness-105 transition"
              />
