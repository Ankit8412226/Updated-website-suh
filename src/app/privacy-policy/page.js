      ...
      <div className="w-full bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 space-y-8">
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            <p>
              This Privacy Notice for SUH Tech Private Limited ("Company", "We", "Us", or "Our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
            </p>

            <ul className="list-disc pl-6 space-y-2">
              <li>
                This Privacy Notice For SUH Tech Private Limited ("Company", "We", "Us", Or "Our"), Describes How And Why We Might Collect, Store, Use, And/Or Share ("Process") Your Information When You Use Our Services ("Services"), Such Visit Our Website At https://www.suhtech.top, Or Any Website Of Ours That Links To This Privacy Notice
              </li>
              <li>
