    ...
    <div className="w-full bg-gray-50 text-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="space-y-4 text-sm leading-relaxed">
          <p>
            This Privacy Notice For Diamond QR.Com ("Company", "We", "Us", Or "Our"), Describes How And Why We Might Collect, Store, Use, And/Or Share ("Process") Your Information When You Use Our Services ("Services"), Such As When You:
          </p>

          <ul className="list-disc pl-6 space-y-2">
            <li>
              This Privacy Notice For Diamond QR.Com ("Company", "We", "Us", Or "Our"), Describes How And Why We Might Collect, Store, Use, And/Or Share ("Process") Your Information When You Use Our Services ("Services"), Such Visit Our Website At Https://Diamond QR.Com, Or Any Website Of Ours That Links To This Privacy Notice
            </li>
            <li>
              Use Our Application(S), Or Any Other Application Of Ours That Links To This Privacy Notice
            </li>
            <li>
              Engage With Us In Other Related Ways — Including Any Sales, Marketing, Or Eventas When You:
            </li>
          </ul>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            ...
            <div className="space-y-3">
              <p>
                <strong>What Personal Information Do We Process?</strong> When You Visit, Use, Or Navigate Our Services, We May Process Personal Information Depending On How You Interact With Diamond Diamond QR.Com And The Services, The Choices You Make, And The Products And Features You Use.
              </p>
